...
public static class DefinitionManifest
{
    ...
    [
        ...
        new("monster_loot", "monsters/monster_loot.json", "../schemas/monsters/monster_loot.schema.json"),
        new("monster_capabilities", "monsters/monster_capabilities.json", "../schemas/monsters/monster_capabilities.schema.json"),
        ...
        new("flavors", "items/flavors.json", "../schemas/flavors.schema.json"),
        new("accessories", "items/accessories.json", "../schemas/items/accessories.schema.json"),
        new("staves", "items/staves.json", "../schemas/items/staves.schema.json"),
        new("wands", "items/wands.json", "../schemas/items/wands.schema.json"),
        new("rods", "items/rods.json", "../schemas/items/rods.schema.json"),
